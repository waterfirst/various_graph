...
## 3차원 그림
 ...
 3차원 시각화는 다차원의 자료를 시각화할 수 있다는 점에서 유용할 수 있다.
...
# 
# plot_gg(ggdiamonds, 
#   multicore = TRUE, width = 5, height =5 , scale = 250, 
#   windowsize=c(140, 86), zoom = 0.55, phi = 30 )
# render_snapshot()
...
library(ggplot2)
data=diamonds
p = ggplot(data, aes(carat, price))+ geom_bin2d( )
p+coord_cartesian(xlim=c(1,3), ylim=c(0,5000))
...
p+scale_x_reverse()+scale_y_log10( )
